...
const TimeTable: React.FC = () => {
  ...
  const data = useStaticQuery(PreCourseTimeTableQuery);
  ...
  return (
    <TimeTableWrapper>
      <TitleSet subtitle={SUBTITLE.PRE_COURSE_TIME_TABLE} title={TITLE.PRE_COURSE_TIME_TABLE} />
      <PlanWrapper>
...
const PreCourseTimeTableQuery = graphql`
  query PreCourseTimeTableQuery {
    mdx(frontmatter: { templateKey: { eq: "preCourse_plan" } }) {
      body
      frontmatter {
        planList {
          name
