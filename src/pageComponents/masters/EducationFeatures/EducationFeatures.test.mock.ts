export const EducationFeatureResult = {
  mdx: {
    frontmatter: {
      features: [
        {
        ...
        },
        {
          ...
          title: "코드스쿼드 커뮤니티",
          content:
            "마스터즈 코스는 2016년도 부터 지금 까지 이어지고 있습니다. 과정 수료 이후에도 코드스쿼드의 멤버로써 지속적인 소통이 가능합니다. 모든 멤버들은 협력하여 함께 성장하는 코드스쿼드 멤버쉽 철학을 따르게 됩니다.",
          img: "communityBlock",
        },
      ],
    },
